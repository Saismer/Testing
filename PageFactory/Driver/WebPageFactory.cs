...
namespace Driver
{
    class WebPageFactory
    {
        ...
        [FindsBy(How = How.XPath, Using = "//*[@id=\"sidebar\"]/div/div/div/div/div[2]/div[2]/ul/li/div[1]/div[1]/div[2]")]
        public IWebElement editMode;

        [FindsBy(How = How.XPath, Using = "//*[@id=\"sidebar\"]/div/div/div/div/div[2]/div[2]/ul/li/div[1]/div[2]/div[1]")]
        public IWebElement edit;

        [FindsBy(How = How.XPath, Using = "//*[@id=\"sidebar\"]/div/div/div/div/div[2]/div[4]/a")]
        public IWebElement searchRightFlight;

        [FindsBy(How = How.XPath, Using = "//*[@id=\"page\"]/div[2]/div[1]/div")]
        public IWebElement focus;
    }
}
